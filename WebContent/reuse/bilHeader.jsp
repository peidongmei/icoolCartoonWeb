...
<body>
		<div id="header">
			<a href="javascript:;" id="background" style="">
			<div id="postword">
				<b></b>
				...
				<div class="head0">
					<div class="head1">
						<ul>
							...
							<li><a href="javascript:;"><c></c>画友</a></li>
							<li><a href="javascript:;"><c></c>游戏中心</a></li>
							<li><a href="javascript:;"><c></c>直播</a></li>
							<li><a href="javascript:;"><c></c>周边</a></li>
							<li style="margin-right: 0;"><a href="javascript:;"><c style="display: block;width: 23px;height: 17px;background: url(/bilibili/img/iconss.png) -850px -411px; float: right;margin-top: 11px;margin-right: 8px;"></c>BML</a></li>
						</ul>
						<ol>
						<c:choose>
							...
							<li style="width: 70px;height: 70px;margin-left: 12px;margin-right: -13px;margin-top: -2px;"class="i_face0">
								<div class="i_face01" style="position: absolute;left:;font-family: '微软雅黑';top: 41px;right: 186px;border: 1px solid #efefef;border-bottom: none;border-top: none;z-index: 1000;background-color: white;">
									<div>
										...
										<div class="bill0" style="position: relative;margin-top: -10px;">
											<div class="bill01"style="margin-left: 20px;width: 100px;"><a href="javascript:;">${user.coin }<c style="display: block;width: 20px;height: 20px;background: url(/bilibili/img/iconss.png) -343px -471px;float: left;margin-top: 11px;margin-right: 7px;"></c></a></div>
											<div class="bill02"style="width: 50px;position: absolute;top: 12px;right: 20px;">
												<a href="javascript:;"style="width: 20px;float: left;"><b style="display: block;width: 20px;height: 20px;background: url(/bilibili/img/iconss.png) -343px -534px;"></b><c></c></a>
												<a href="javascript:;" style="display: block; float: right;width: 20px;"><b style="display: block;width: 20px;height: 20px;background: url(/bilibili/img/iconss.png) -277px -599px;"></b><c></c></a>
											</div>
										</div>
										...
										<ul class="four">
											<div id="four_1">
												...
												<li><a href="javascript:;" class="face_tggl"><div class="face_tggl0"></div>投稿管理</a></li>
											</div>
											<div id="four_2">
												<li><a href="javascript:;" class="face_wdqb"><div class="face_wdqb0"></div>我的钱包</a></li>
												<li><a href="javascript:;" class="face_zbzx"><div class="face_zbzx0"></div>直播中心</a></li>
											</div>
										</ul>
								...
								<a href="javascript:;" class="i_face" style="z-index: 2000; background: url(${user.facepath}) ;background-size:100%;"></a>
								
							</li>
							<li style="margin-left: 20px;"><a href="javascript:;"><c></c>消息</a></li>
							<li><a href="javascript:;"><c></c>动态</a></li>
							<li><a href="javascript:;"><c></c>收藏夹</a></li>
							<li><a href="javascript:;"><c></c>历史</a></li>
						 </c:when>
						<c:otherwise>
									<li><a style="outline:none;text-decoration:none" href="/bilibili/userLogin.html">登录</a></li>
									<li><a style="outline:none;text-decoration:none" href="/bilibili/userRegist.html">注册</a></a></li>
						</c:otherwise>
						</c:choose>  
							<li class="nav_tg" style="margin-left: 17px;">
								<a href="javascript:;" style="color: white;">投 稿</a>
								<div class="nav_tg0">
									<div><a href="javascript:;"><c style="display: block;width: 23px;height: 20px;background: url(/bilibili/img/iconss.png) -470px -918px;margin-left: 25px;margin-bottom: -10px;margin-top: 15px;"></c>视频投稿</a></div>
									<div><a href="javascript:;"><c style="display: block;width: 23px;height: 20px;background: url(/bilibili/img/iconss.png) -470px -981px;margin-left: 25px;margin-bottom: -10px;margin-top: 15px;"></c>投稿管理</a></div>
								</div>
							</li>
						</ol>
			...
			<div style="width: 155px;height: 70px;position:absolute;top:60px;left:230px">
				<a href="javascript:;"><img src="/bilibili/img/logo.png"></a>
			</div>
			<div class="search clearfix">
				<a href=""><b class="b4"></b><span style="padding: 5px;">排行榜</span></a>
				<div class="form">
					<input type="text" name="" id="search_input" value="" placeholder="&nbsp;&nbsp;一天不听，我浑身难受!" style="outline: none;"/>
					<a href="" id="b5"></a>
					<div id="search_tips">
						<span>关键词</span>
						<div id="search_tips0"></div>
						<ul id="search_tips1">
							<!--<li><a href="">刀剑神域第一集</a></li>
							<li><a href="">刀剑神域第二集</a></li>
							<li><a href="">刀剑神域第三集</a></li>
							<li><a href="">刀剑神域第四集</a></li>
							<li><a href="">刀剑神域第五集</a></li>-->
						</ul>
					</div>
					<script type="text/javascript">
						$(function () {
							...
							var sli =$('#search_tips1');
							
							var Sval =$('#search_input').val();
							if(Sval){
								$('#search_tips').css("display","block")
							}else{
								$('#search_tips').css("display","none")
							}
							sval=""+Sval;
							$.getJSON('/bilibili/video/search',{Sval:sval},function (data) {
								$('#search_tips1').empty();
								var html ='';
		...
		<div id="bigNav">
			...
			<div id="nav1">
				<ul id="nav11" class="clearfx">
					<li><a href="/bilibili/HomePage.jsp" class="lili"><d style="background:url(/bilibili/img/iconss.png) -661px -1176px; "></d><span>首页</span></a>
						
					</li>
					<li><a href="javascript:;" class="lili"><d>78</d><span>动画</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>21</d><span>番剧</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>46</d><span>音乐</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>88</d><span>舞蹈</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>420</d><span>游戏</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>84</d><span>科技</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>324</d><span>娱乐</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>8</d><span>鬼畜</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>28</d><span>时尚</span></a>
						<ul class="sub_menu">
					...
					<li><a href="javascript:;" class="lili"><d>120</d><span>影视</span></a>
						<ul class="sub_menu">
							<li><a href=""><b></b><span>电影</span><c></c></a></li>
							<li><a href=""><b></b><span>电视剧</span><c></c></a></li>
						</ul>
					</li>
					<li class="sub2" style="margin-top: 2px;"><a href="javascript:;" class="lili"><d style="float: left;background: url(/bilibili/img/iconss.png) -664px -918px;height: 25px;margin-top: 8px;"></d>
					...
					<li style="margin-top: 2px;"><a href="javascript:;" class="lili"><d style="float: left;height: 25px;background: url(/bilibili/img/iconss.png) -664px -532px;margin-top: 8px;"></d>
					...
					<li style="width: 42px;">
						<a href="javascript:;" class="lili"><d style="display: block;width: 80px;height: 40px;background: url(/bilibili/img/cake.gif);float: left;"></d></a>
					</li>
					<li class="last" style="float: right;width: 61px;margin-right: 0;">
						<a href="javascript:;" style="display: block;width: 60px;height: 35px;margin-top: 2px;" class="lili"></a>
